    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-primary/5 to-pink/5">
      ...
      <main className="container mx-auto px-4 py-8 space-y-8">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">Enable modern glass-like visual effects</p>
              </div>
          ...
          <CardContent className="space-y-6">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">Get notified when diseases are detected in your scans</p>
              </div>
              <Switch defaultChecked />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">Receive weekly summaries of your farm health</p>
              </div>
              <Switch defaultChecked />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">Reminders for recommended treatments</p>
              </div>
              <Switch />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">Updates about new features and farming tips</p>
              </div>
              <Switch />
            </div>

            <div className="space-y-2">
              <Label htmlFor="notificationMethod" className="text-foreground">
                Notification Method
              </Label>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">Automatically save all scan results to your history</p>
              </div>
              <Switch defaultChecked />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">Enable scanning without internet connection</p>
              </div>
              <Switch />
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-6">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">Help improve our AI by sharing anonymous usage data</p>
              </div>
              <Switch defaultChecked />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">Allow location access for weather and regional insights</p>
              </div>
              <Switch defaultChecked />
            </div>
        ...
        <Card className="glass-card hover:glass transition-all duration-300">
          ...
          <CardContent className="space-y-6">
            <div className="flex items-center justify-between p-6 border rounded-xl glass">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Unlimited scans, priority support</p>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between p-4 border rounded-xl glass">
        ...
        <Card className="glass-card hover:glass transition-all duration-300 border-red-200/20">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-4 border border-red-200/20 rounded-xl glass">
              <div>
