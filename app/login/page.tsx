    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-pink-100 to-purple-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors p-2 sm:p-4">
      <Card className="w-full max-w-md glass-card shadow-2xl border-0 rounded-2xl sm:rounded-3xl px-2 sm:px-6 py-6 sm:py-10">
        <CardHeader className="text-center mb-2 sm:mb-4">
          ...
          <CardDescription className="text-muted-foreground mt-1 sm:mt-2 text-base">Sign in to your account</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <Button type="button" variant="outline" className="w-full flex items-center justify-center font-semibold bg-white text-black border hover:bg-gray-100 transition rounded-lg shadow-sm py-3 text-base sm:text-lg" onClick={handleGoogleSignIn}>
          ...
          <form className="space-y-4" onSubmit={handleEmailLogin}>
            ...
            <div className="space-y-2">
              ...
              <Input id="password" name="password" placeholder="Enter your password" type="password" className="glass w-full px-4 py-3 rounded-lg text-base" autoComplete="current-password" />
            </div>
